...
我使用ChatGPT的Image2生成了一套初音未来主题的切换图标，然后使用这个[在线图标生成器](https://d1tools.com/tools/ico-generator/)生成了ico文件
...
![简繁切换](/traditionalization.png)
_简繁切换_

我的ico图标文件可以在这里[下载](/assets/20260608/icon.rar);
